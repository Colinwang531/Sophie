...
static void InitDefaultsscc_info_StatusRequest_Status_2eproto() {
  ...
  ::msg::StatusRequest::InitAsDefaultInstance();
}
...
static void InitDefaultsscc_info_StatusResponse_Status_2eproto() {
  ...
  ::msg::StatusResponse::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_Status_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::msg::StatusRequest, name_),
  2,
  1,
  0,
  ...
  PROTOBUF_FIELD_OFFSET(::msg::StatusResponse, name_),
  1,
  2,
  0,
...
const char descriptor_table_protodef_Status_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014Status.proto\022\003msg\"x\n\rStatusRequest\022%\n\004"
  "type\030\001 \002(\0162\027.msg.StatusRequest.Type\022\014\n\004f"
  "lag\030\002 \001(\010\022\014\n\004name\030\003 \001(\t\"$\n\004Type\022\010\n\004SAIL\020"
  "\001\022\010\n\004AUTO\020\002\022\010\n\004NAME\020\003\"<\n\016StatusResponse\022"
  "\016\n\006result\030\001 \002(\005\022\014\n\004flag\030\002 \001(\010\022\014\n\004name\030\003 "
  "\001(\t\"\311\001\n\006Status\022$\n\007command\030\001 \002(\0162\023.msg.St"
  "atus.Command\022)\n\rstatusrequest\030\002 \001(\0132\022.ms"
  "g.StatusRequest\022+\n\016statusresponse\030\003 \001(\0132"
  "\023.msg.StatusResponse\"A\n\007Command\022\013\n\007SET_R"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Status_2eproto = {
  false, false, descriptor_table_protodef_Status_2eproto, "Status.proto", 407,
...
constexpr StatusRequest_Type StatusRequest::AUTO;
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "msg.StatusRequest.name");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "msg.StatusResponse.name");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
void Status::InitAsDefaultInstance() {
  ::msg::_Status_default_instance_._instance.get_mutable()->statusrequest_ = const_cast< ::msg::StatusRequest*>(
      ::msg::StatusRequest::internal_default_instance());
  ::msg::_Status_default_instance_._instance.get_mutable()->statusresponse_ = const_cast< ::msg::StatusResponse*>(
      ::msg::StatusResponse::internal_default_instance());
}

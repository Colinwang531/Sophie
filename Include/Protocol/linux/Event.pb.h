...
inline bool Event_Command_Parse(
    const std::string& name, Event_Command* value) {
...
class Ais PROTOBUF_FINAL :
 ...
 public:
  ...
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_longitude();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  ...
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_latitude();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
...
inline std::string* CaptureInfo::unsafe_arena_release_did() {
  // @@protoc_insertion_point(field_unsafe_arena_release:msg.CaptureInfo.did)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return did_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void CaptureInfo::unsafe_arena_set_allocated_did(
    std::string* did) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (did != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  did_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      did, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:msg.CaptureInfo.did)
}
...
inline std::string* CaptureInfo::unsafe_arena_release_cid() {
  // @@protoc_insertion_point(field_unsafe_arena_release:msg.CaptureInfo.cid)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000002u;
  return cid_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void CaptureInfo::unsafe_arena_set_allocated_cid(
    std::string* cid) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (cid != nullptr) {
    _has_bits_[0] |= 0x00000002u;
  ...
  cid_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      cid, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:msg.CaptureInfo.cid)
}
...
inline std::string* CaptureInfo::unsafe_arena_release_picture() {
  // @@protoc_insertion_point(field_unsafe_arena_release:msg.CaptureInfo.picture)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000004u;
  return picture_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void CaptureInfo::unsafe_arena_set_allocated_picture(
    std::string* picture) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (picture != nullptr) {
    _has_bits_[0] |= 0x00000004u;
  ...
  picture_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      picture, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:msg.CaptureInfo.picture)
}
...
inline std::string* Clock::unsafe_arena_release_time() {
  // @@protoc_insertion_point(field_unsafe_arena_release:msg.Clock.time)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return time_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Clock::unsafe_arena_set_allocated_time(
    std::string* time) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (time != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  time_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      time, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:msg.Clock.time)
}
...
inline std::string* Ais::unsafe_arena_release_longitude() {
  // @@protoc_insertion_point(field_unsafe_arena_release:msg.Ais.longitude)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return longitude_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Ais::unsafe_arena_set_allocated_longitude(
    std::string* longitude) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (longitude != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  longitude_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      longitude, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:msg.Ais.longitude)
}
...
inline std::string* Ais::unsafe_arena_release_latitude() {
  // @@protoc_insertion_point(field_unsafe_arena_release:msg.Ais.latitude)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000002u;
  return latitude_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Ais::unsafe_arena_set_allocated_latitude(
    std::string* latitude) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (latitude != nullptr) {
    _has_bits_[0] |= 0x00000002u;
  ...
  latitude_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      latitude, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:msg.Ais.latitude)
}

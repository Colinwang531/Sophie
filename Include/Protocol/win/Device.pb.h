...
inline bool DeviceInfo_Factory_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, DeviceInfo_Factory* value) {
...
inline bool DeviceInfo_Type_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, DeviceInfo_Type* value) {
...
inline bool Device_Command_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, Device_Command* value) {
